...
export const integrationProject: Project = {
    ...
    description: "보안 장비 5종의 방대한 로그를 표준화하여 통합하고, AI 필터링을 통해 매일 수천 건에 달하는 룰베이스 오탐(False Positive)을 획기적으로 줄인 신규 이상탐지 플랫폼 구축 프로젝트입니다.",
    overview: {
        background: "기존에는 5종 이상의 보안 솔루션(DLP, 로그 등)에서 발생하는 수많은 탐지 내역을 담당자가 룰베이스로만 일일이 확인해야 했으며, 오탐이 너무 많아 실제 위협을 놓칠 위험이 컸습니다.",
