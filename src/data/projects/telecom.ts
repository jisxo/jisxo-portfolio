...
export const telecomProject: Project = {
    ...
    description: "전사 보안 솔루션의 탐지 로그를 분석하여 AI 필터링을 도입함으로써, 매일 발생하는 수천 건의 룰베이스 오탐(False Positive)을 획기적으로 줄이고 운영 안정성을 강화한 프로젝트입니다.",
    overview: {
        background: "기존의 데이터 유출 방지(DLP) 시스템은 단순 룰베이스 탐지에 의존하여, 담당자가 매일 사후 검토해야 하는 로그가 너무 많고 오탐률이 높아 실제 위협을 포착하는 데 한계가 있었습니다.",
