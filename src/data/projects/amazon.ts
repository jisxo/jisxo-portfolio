...
export const amazonProject: Project = {
    ...
    overview: {
        background: "미국, 일본 등 10개국의 방대한 광고 캠페인을 소수 인원이 관리하며 발생하는 운영 리소스 과부하와 업무 실수가 심각한 문제였습니다.",
        objective: "기존의 수동 입찰 및 키워드 관리 프로세스를 24시간 자동 가동되는 알고리즘 기반 자동화 체제로 전환하여 운영 공백을 제거하고자 했습니다.",
        outcome: "월 150시간의 수작업을 2.5시간으로 대폭 단축하였으며, 데이터 대시보드를 통해 성과 지표 가시성을 확보했습니다."
    },
