...
export const amazonProject: Project = {
    ...
    star: {
        ...
        action: `Amazon Advertising API 기반의 백엔드 로직을 구현하여 데이터를 직접 제어하고, Apache Airflow를 활용해 24시간 자동 입찰 및 키워드 관리 파이프라인을 구축했습니다.
또한 Django 기반의 대시보드를 개발하여 RPA 실행 결과와 성과 지표를 한눈에 모니터링할 수 있는 체계를 마련했습니다.`,
        result: `월 150시간의 수작업 소요 시간을 2.5시간으로 98.3% 단축하는 성과를 거두었습니다.
심야 및 공휴일에도 가동되는 24/7 자동화 체제를 통해 광고 운영의 일관성을 확보하고, 담당자가 전략적 의사결정에 집중할 수 있는 환경을 조성했습니다.`
    },
    contributions: [
