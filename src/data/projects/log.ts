...
export const logProject: Project = {
    ...
    star: {
        ...
        action: 'Python 기반의 전처리 모듈을 직접 개발하여 기존 배치 솔루션과 연동시킴으로써 데이터 수집부터 가공까지의 전 과정을 100% 자동화하고, 시간/부서/키워드별 다차원 EDA를 수행하여 이상징후 탐지 룰 설정을 위한 통계적 근거를 확보했습니다.',
        result: '이를 통해 수동 데이터 추출에 소요되던 공수를 최소화하여 분석 효율을 극대화했으며, 통계적 근거 기반의 정량적 탐지 룰(Rule)을 도출하여 보안 관제 고도화의 핵심 기반을 완성했습니다.'
    },
    contributions: [
